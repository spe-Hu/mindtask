...
项目详细文档位于 `docs/` 目录。**不要在 AGENTS.md 重复这些内容**，直接指向对应文档。

| 文档 | 用途 | 何时阅读 |
|------|------|----------|
| [docs/INDEX.md](docs/INDEX.md) | 文档导航和阅读指南 | 首次接手项目 |
| [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md) | 系统架构、数据流、Store 设计、数据模型 | 理解系统原理、添加新功能 |
| [docs/INTEGRATION.md](docs/INTEGRATION.md) | 集成指南、部署方式、API 使用 | 部署应用、构建桌面版 |
| [docs/RUNBOOK.md](docs/RUNBOOK.md) | 运维手册、故障排查、备份恢复 | 日常运维、处理故障 |
| [docs/CHANGELOG.md](docs/CHANGELOG.md) | 版本历史、更新日志、升级指南 | 了解版本变更 |

### 文档更新规则

以下变更**必须**同步更新对应文档：

1. **新增功能** → 更新 `docs/ARCHITECTURE.md` 和 `docs/INTEGRATION.md`
2. **修改数据模型** → 更新 `docs/ARCHITECTURE.md` 的 IndexedDB 数据模型
3. **新增路由** → 更新 `docs/ARCHITECTURE.md` 的路由系统
4. **新增 Store** → 更新 `docs/ARCHITECTURE.md` 的 Store 详细设计
5. **修改部署方式** → 更新 `docs/INTEGRATION.md` 和 `docs/RUNBOOK.md`
6. **发布新版本** → 更新 `docs/CHANGELOG.md`
7. **发现故障** → 更新 `docs/RUNBOOK.md` 的故障排查
